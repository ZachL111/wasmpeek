"""Regression checks for the wasmpeek casebook."""
...
from casebook.harness import assert_expected, wasmpeek_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(wasmpeek_summary(), assert_expected())
