...
wasmpeek is a JavaScript project for developer tools. It focuses on this technical goal: Inspect WebAssembly text fragments for imports and exports.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 176, risk penalty 7, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
