...
`wasmpeek` is centered on developer tools work in JavaScript. The technical target is: Inspect WebAssembly text fragments for imports and exports.
...
The score is deterministic. The current threshold is 176. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 6.
